...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              feature_ = new java.util.ArrayList<routeguide.Feature>();
              mutable_bitField0_ |= 0x00000001;
            }
            feature_.add(
                input.readMessage(routeguide.Feature.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return routeguide.RouteGuideProto.internal_static_routeguide_FeatureDatabase_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return routeguide.RouteGuideProto.internal_static_routeguide_FeatureDatabase_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            routeguide.FeatureDatabase.class, routeguide.FeatureDatabase.Builder.class);
  }

  public static final int FEATURE_FIELD_NUMBER = 1;
  private java.util.List<routeguide.Feature> feature_;
  /**
   * <code>repeated .routeguide.Feature feature = 1;</code>
   */
  @java.lang.Override
  public java.util.List<routeguide.Feature> getFeatureList() {
    return feature_;
  }
  /**
   * <code>repeated .routeguide.Feature feature = 1;</code>
   */
  @java.lang.Override
  public java.util.List<? extends routeguide.FeatureOrBuilder> 
   ...
   */
  @java.lang.Override
  public routeguide.Feature getFeature(int index) {
   ...
   */
  @java.lang.Override
  public routeguide.FeatureOrBuilder getFeatureOrBuilder(
      int index) {
    return feature_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof routeguide.FeatureDatabase)) {
      return super.equals(obj);
    }
    routeguide.FeatureDatabase other = (routeguide.FeatureDatabase) obj;
  ...
  public static routeguide.FeatureDatabase parseFrom(
  ...
  public static routeguide.FeatureDatabase parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static routeguide.FeatureDatabase parseFrom(
  ...
  public static routeguide.FeatureDatabase parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static routeguide.FeatureDatabase parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static routeguide.FeatureDatabase parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(routeguide.FeatureDatabase prototype) {
  ...
  public static final class Builder extends
      ...
      routeguide.FeatureDatabaseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return routeguide.RouteGuideProto.internal_static_routeguide_FeatureDatabase_descriptor;
    }
    ...
    // Construct using routeguide.FeatureDatabase.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public routeguide.FeatureDatabase getDefaultInstanceForType() {
      return routeguide.FeatureDatabase.getDefaultInstance();
    }

    @java.lang.Override
    public routeguide.FeatureDatabase build() {
      routeguide.FeatureDatabase result = buildPartial();
    ...
    @java.lang.Override
    public routeguide.FeatureDatabase buildPartial() {
      routeguide.FeatureDatabase result = new routeguide.FeatureDatabase(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof routeguide.FeatureDatabase) {
        return mergeFrom((routeguide.FeatureDatabase)other);
      } else {
    ...
    public Builder mergeFrom(routeguide.FeatureDatabase other) {
      if (other == routeguide.FeatureDatabase.getDefaultInstance()) return this;
      if (featureBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      routeguide.FeatureDatabase parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (routeguide.FeatureDatabase) e.getUnfinishedMessage();
    ...
    private void ensureFeatureIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        feature_ = new java.util.ArrayList<routeguide.Feature>(feature_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        routeguide.Feature, routeguide.Feature.Builder, routeguide.FeatureOrBuilder> featureBuilder_;
    ...
    public Builder setFeature(
        int index, routeguide.Feature value) {
      if (featureBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setFeature(
        int index, routeguide.Feature.Builder builderForValue) {
      if (featureBuilder_ == null) {
        ensureFeatureIsMutable();
     ...
     * <code>repeated .routeguide.Feature feature = 1;</code>
     */
    public Builder addFeature(routeguide.Feature value) {
      if (featureBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addFeature(
        routeguide.Feature.Builder builderForValue) {
      if (featureBuilder_ == null) {
        ensureFeatureIsMutable();
    ...
    public Builder addAllFeature(
        java.lang.Iterable<? extends routeguide.Feature> values) {
      if (featureBuilder_ == null) {
        ensureFeatureIsMutable();
     ...
     * <code>repeated .routeguide.Feature feature = 1;</code>
     */
    public routeguide.Feature.Builder getFeatureBuilder(
        int index) {
     ...
     * <code>repeated .routeguide.Feature feature = 1;</code>
     */
    public routeguide.Feature.Builder addFeatureBuilder() {
    ...
    public routeguide.Feature.Builder addFeatureBuilder(
        int index) {
      return getFeatureFieldBuilder().addBuilder(
          index, routeguide.Feature.getDefaultInstance());
    }
    /**
     * <code>repeated .routeguide.Feature feature = 1;</code>
     */
    public java.util.List<routeguide.Feature.Builder> 
         getFeatureBuilderList() {
      return getFeatureFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        routeguide.Feature, routeguide.Feature.Builder, routeguide.FeatureOrBuilder> 
        getFeatureFieldBuilder() {
      if (featureBuilder_ == null) {
  ...
  private static final routeguide.FeatureDatabase DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new routeguide.FeatureDatabase();
  }

  public static routeguide.FeatureDatabase getDefaultInstance() {
