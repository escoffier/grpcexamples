...
public final class RouteGuideGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<routeguide.Point,
      routeguide.Feature> getGetFeatureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeature",
      requestType = routeguide.Point.class,
      responseType = routeguide.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<routeguide.Point,
      routeguide.Feature> getGetFeatureMethod() {
    io.grpc.MethodDescriptor<routeguide.Point, routeguide.Feature> getGetFeatureMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getGetFeatureMethod = RouteGuideGrpc.getGetFeatureMethod) == null) {
          RouteGuideGrpc.getGetFeatureMethod = getGetFeatureMethod =
              io.grpc.MethodDescriptor.<routeguide.Point, routeguide.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeature"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  routeguide.Point.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  routeguide.Feature.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<routeguide.Rectangle,
      routeguide.Feature> getListFeaturesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListFeatures",
      requestType = routeguide.Rectangle.class,
      responseType = routeguide.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<routeguide.Rectangle,
      routeguide.Feature> getListFeaturesMethod() {
    io.grpc.MethodDescriptor<routeguide.Rectangle, routeguide.Feature> getListFeaturesMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getListFeaturesMethod = RouteGuideGrpc.getListFeaturesMethod) == null) {
          RouteGuideGrpc.getListFeaturesMethod = getListFeaturesMethod =
              io.grpc.MethodDescriptor.<routeguide.Rectangle, routeguide.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListFeatures"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  routeguide.Rectangle.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  routeguide.Feature.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<routeguide.Point,
      routeguide.RouteSummary> getRecordRouteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RecordRoute",
      requestType = routeguide.Point.class,
      responseType = routeguide.RouteSummary.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<routeguide.Point,
      routeguide.RouteSummary> getRecordRouteMethod() {
    io.grpc.MethodDescriptor<routeguide.Point, routeguide.RouteSummary> getRecordRouteMethod;
    if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
          RouteGuideGrpc.getRecordRouteMethod = getRecordRouteMethod =
              io.grpc.MethodDescriptor.<routeguide.Point, routeguide.RouteSummary>newBuilder()
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  routeguide.Point.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  routeguide.RouteSummary.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<routeguide.RouteNote,
      routeguide.RouteNote> getRouteChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RouteChat",
      requestType = routeguide.RouteNote.class,
      responseType = routeguide.RouteNote.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<routeguide.RouteNote,
      routeguide.RouteNote> getRouteChatMethod() {
    io.grpc.MethodDescriptor<routeguide.RouteNote, routeguide.RouteNote> getRouteChatMethod;
    if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
          RouteGuideGrpc.getRouteChatMethod = getRouteChatMethod =
              io.grpc.MethodDescriptor.<routeguide.RouteNote, routeguide.RouteNote>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RouteChat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  routeguide.RouteNote.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  routeguide.RouteNote.getDefaultInstance()))
  ...
  public static abstract class RouteGuideImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeature(routeguide.Point request,
        io.grpc.stub.StreamObserver<routeguide.Feature> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<routeguide.Point> recordRoute(
        io.grpc.stub.StreamObserver<routeguide.RouteSummary> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<routeguide.RouteNote> routeChat(
        io.grpc.stub.StreamObserver<routeguide.RouteNote> responseObserver) {
  ...
  public static final class RouteGuideBlockingStub extends io.grpc.stub.AbstractBlockingStub<RouteGuideBlockingStub> {
     ...
     * </pre>
     */
    public routeguide.Feature getFeature(routeguide.Point request) {
     ...
     * </pre>
     */
    public java.util.Iterator<routeguide.Feature> listFeatures(
  ...
  public static final class RouteGuideFutureStub extends io.grpc.stub.AbstractFutureStub<RouteGuideFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<routeguide.Feature> getFeature(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEATURE:
          serviceImpl.getFeature((routeguide.Point) request,
              (io.grpc.stub.StreamObserver<routeguide.Feature>) responseObserver);
          break;
        case METHODID_LIST_FEATURES:
          serviceImpl.listFeatures((routeguide.Rectangle) request,
              (io.grpc.stub.StreamObserver<routeguide.Feature>) responseObserver);
          break;
        default:
  ...
  private static abstract class RouteGuideBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return routeguide.RouteGuideProto.getDescriptor();
    }
