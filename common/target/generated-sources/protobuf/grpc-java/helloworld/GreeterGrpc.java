...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<helloworld.IdMessage,
      helloworld.NameMessage> getGetNameMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetName",
      requestType = helloworld.IdMessage.class,
      responseType = helloworld.NameMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<helloworld.IdMessage,
      helloworld.NameMessage> getGetNameMethod() {
    io.grpc.MethodDescriptor<helloworld.IdMessage, helloworld.NameMessage> getGetNameMethod;
    if ((getGetNameMethod = GreeterGrpc.getGetNameMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getGetNameMethod = GreeterGrpc.getGetNameMethod) == null) {
          GreeterGrpc.getGetNameMethod = getGetNameMethod =
              io.grpc.MethodDescriptor.<helloworld.IdMessage, helloworld.NameMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetName"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  helloworld.IdMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  helloworld.NameMessage.getDefaultInstance()))
              .setSchemaDescriptor(new GreeterMethodDescriptorSupplier("GetName"))
              .build();
        }
      }
    }
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getName(helloworld.IdMessage request,
        io.grpc.stub.StreamObserver<helloworld.NameMessage> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                helloworld.IdMessage,
                helloworld.NameMessage>(
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
    ...
    /**
     */
    public helloworld.NameMessage getName(helloworld.IdMessage request) {
      return blockingUnaryCall(
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<helloworld.NameMessage> getName(
        helloworld.IdMessage request) {
      return futureUnaryCall(
  ...
  private static final int METHODID_GET_NAME = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_NAME:
          serviceImpl.getName((helloworld.IdMessage) request,
              (io.grpc.stub.StreamObserver<helloworld.NameMessage>) responseObserver);
          break;
        default:
