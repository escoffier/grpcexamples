...
@javax.annotation.Generated(
    ...
    comments = "Source: check_health.proto")
public final class HealthGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.health.v1.CheckHealth.HealthCheckRequest,
      grpc.health.v1.CheckHealth.HealthCheckResponse> getCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Check",
      requestType = grpc.health.v1.CheckHealth.HealthCheckRequest.class,
      responseType = grpc.health.v1.CheckHealth.HealthCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.health.v1.CheckHealth.HealthCheckRequest,
      grpc.health.v1.CheckHealth.HealthCheckResponse> getCheckMethod() {
    io.grpc.MethodDescriptor<grpc.health.v1.CheckHealth.HealthCheckRequest, grpc.health.v1.CheckHealth.HealthCheckResponse> getCheckMethod;
    if ((getCheckMethod = HealthGrpc.getCheckMethod) == null) {
      synchronized (HealthGrpc.class) {
        if ((getCheckMethod = HealthGrpc.getCheckMethod) == null) {
          HealthGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<grpc.health.v1.CheckHealth.HealthCheckRequest, grpc.health.v1.CheckHealth.HealthCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Check"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.health.v1.CheckHealth.HealthCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.health.v1.CheckHealth.HealthCheckResponse.getDefaultInstance()))
  ...
  public static abstract class HealthImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void check(grpc.health.v1.CheckHealth.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<grpc.health.v1.CheckHealth.HealthCheckResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.health.v1.CheckHealth.HealthCheckRequest,
                grpc.health.v1.CheckHealth.HealthCheckResponse>(
                  this, METHODID_CHECK)))
          .build();
    }
  }
  ...
  public static final class HealthBlockingStub extends io.grpc.stub.AbstractBlockingStub<HealthBlockingStub> {
    ...
    /**
     */
    public grpc.health.v1.CheckHealth.HealthCheckResponse check(grpc.health.v1.CheckHealth.HealthCheckRequest request) {
  ...
  public static final class HealthFutureStub extends io.grpc.stub.AbstractFutureStub<HealthFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.health.v1.CheckHealth.HealthCheckResponse> check(
        grpc.health.v1.CheckHealth.HealthCheckRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((grpc.health.v1.CheckHealth.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<grpc.health.v1.CheckHealth.HealthCheckResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HealthBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.health.v1.CheckHealth.getDescriptor();
    }
